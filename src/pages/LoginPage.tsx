      ...
      >
        ...
        <div className="w-full rounded-2xl border border-border bg-muted/50 p-8 shadow-xl backdrop-blur-sm">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-accent px-6 py-3.5 font-heading font-semibold text-white shadow-lg shadow-accent/25 transition-all hover:bg-accent/90 active:scale-[0.98] disabled:opacity-60 cursor-pointer"
          >
            {isLoading ? (
