  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pt-24 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-muted/20 py-20">
        ...
        <button className="mt-6 flex items-center gap-2 rounded-xl bg-accent px-5 py-2.5 font-heading font-semibold text-white shadow-lg shadow-accent/20 transition-all hover:bg-accent/90 active:scale-[0.98] cursor-pointer">
